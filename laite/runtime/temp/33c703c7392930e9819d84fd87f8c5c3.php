<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\laite\public/../application/index\view\wealth\cash.html";i:1512352578;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\footer.html";i:1512184643;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <section class="sidebar">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><?php echo \think\Lang::get('chongzhitixian'); ?></h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="index.html"><i class="fa fa-dashboard"></i><?php echo \think\Lang::get('shouye'); ?></a>
                    </li>
                    <li class="active"><?php echo \think\Lang::get('chongzhitixian'); ?></li>
                </ol>
            </section>
            <!-- Main content -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab_1" data-toggle="tab"><?php echo \think\Lang::get('chongzhi'); ?></a>
                                </li>
                                <li>
                                    <a href="#tab_2" data-toggle="tab"><?php echo \think\Lang::get('tixian'); ?></a>
                                </li>
                            </ul>
                                                    ...
                                                    <form id="txform1">
                                                        <div class="box-body">
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('chongzhidizhi'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="text" value="<?php echo $system['gathering_address']; ?>" name="gathering_address" id="" class="form-control" readonly="true" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('jine'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="text" value="" name="num" id="" class="form-control" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('zhanghuxinxi'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="text" value="" name="user_info" id="" class="form-control" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('anquanmima'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="password" value="" name="second_pass" class="form-control txinput" placeholder="" />
                                                                    <label class="control-label  txprompt" id=""></label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    <input type="submit" name="submit" id="chong" onclick="return chongzhi()"  value="<?php echo \think\Lang::get('queren'); ?>" class=' btn btn-primary pull-right txsubmit'>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                    ...
                                                    <form id="txform2">
                                                        <div class="box-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" value="<?php echo $detail['litecoin_wallet']; ?>" name="litecoin_wallet" id="" class="form-control" readonly="true" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('tixiandizhi'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="text" value="<?php echo $detail['withdraw_address']; ?>" name="withdraw_address" id="" class="form-control" readonly="true"/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('tixianshouxufei'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="text" value="<?php echo $system['service_charge']; ?>%" name="service_charge" id="" class="form-control" readonly="true"/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label><?php echo \think\Lang::get('jine'); ?></label>
                                                                <div class="form-group">
                                                                    <input type="text" value="" name="num" id="" class="form-control txinput timoney" />
                                                                    <label class="control-label  txprompt" id=""></label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    <input type="submit" id="ti" onclick="return tixian()" name="submit" id="" value="<?php echo \think\Lang::get('queren'); ?>" class=' btn btn-primary pull-right txsubmit'> </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
...
<script type="text/javascript">
    function chongzhi(){
        console.log(123);
        $('#chong').attr('disabled',true);
        $.ajax({
            type:"post",
            url:"<?php echo url('chongzhi'); ?>",
            data:$('#txform1').serialize(),
    ...
    function tixian(){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('tixian'); ?>",
            data:$('#txform2').serialize(),
            success:function(data){
                console.log(data);
                layer.msg(data.msg);
                if(data.code){
...
//      $(".xitonggongao").addClass("active").siblings().removeClass("active");
</script>
