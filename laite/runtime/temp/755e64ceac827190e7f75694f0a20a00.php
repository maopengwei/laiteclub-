<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpStudy\WWW\laite\public/../application/index\view\news\relation_list.html";i:1512204018;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\footer.html";i:1512184643;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <ul class="sidebar-menu">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1><?php echo \think\Lang::get('liuyanliebiao'); ?></h1>
					<ol class="breadcrumb">
						<li>
							<a href="index.html"><i class="fa fa-dashboard"></i> <?php echo \think\Lang::get('shouye'); ?></a>
						</li>
						<li class="active"><?php echo \think\Lang::get('liuyanliebiao'); ?></li>
					</ol>
				</section>
						...
						<div class="col-xs-12">
							<div class="nav-tabs-custom">
								<div class="tab-content">
									...
									<div class="box-body">
										<div class="callout callout-info"><?php echo \think\Lang::get('liuyanliebiao'); ?><?php echo \think\Lang::get('zonggongyou'); ?> <b class="text_red_line"><?php echo $count; ?></b><?php echo \think\Lang::get('tiaojilu'); ?></div>
									</div>
									<div class="box-body table-responsive">
										<table class="table table-bordered table-hover">
											<thead>
												<tr>
													<th><?php echo \think\Lang::get('biaoti'); ?></th>
													<th><?php echo \think\Lang::get('neirong'); ?></th>
													<th><?php echo \think\Lang::get('tupian'); ?></th>
													<th><?php echo \think\Lang::get('liuyanshijian'); ?></th>
													<th><?php echo \think\Lang::get('zhuangtai'); ?></th>
													<th><?php echo \think\Lang::get('huifu'); ?></th>
													<th><?php echo \think\Lang::get('huifushijian'); ?></th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													...
													<td>
														<?php if($v['img'] == ''): ?><?php echo \think\Lang::get('meiyoutupian'); endif; if($v['img'] != ''): ?><span onclick="look(<?php echo $v['id']; ?>)" ><?php echo \think\Lang::get('dianjichakan'); ?></span><?php endif; ?>
													</td>
													<td><?php echo date("Y-m-d H:i:s",$v['add_time']); ?></td>
													<td><?php echo $v['status']; ?></td>
													<td><?php echo $v['reply']; ?></td>
													<td><?php if($v['reply_time']): ?><?php echo date('Y-m-d H:i:s',$v['reply_time']); else: endif; ?></td>
												</tr>
												<img class="voucher<?php echo $v['id']; ?>" src="<?php echo $v['img']; ?>" onclick="out(this)" style="display:none;">
