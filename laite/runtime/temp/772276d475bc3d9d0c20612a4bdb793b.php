<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\phpStudy\WWW\laite\public/../application/index\view\wealth\cash_list.html";i:1512352934;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\footer.html";i:1512184643;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <!-- jvectormap地图插件 -->
    <link rel="stylesheet" type="text/css" href="__STATIC__/admin/css/pages.css" />
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?php echo \think\Lang::get('laitejulebu'); ?></li>
                </ol>
            </section>
            <!-- Main content -->
                            ...
                            <div class="tab-content">
                                <div class="box-body">
                                    <div class="callout callout-info">
                                        <p><?php echo \think\Lang::get('laitejulebu'); ?>：<?php echo \think\Lang::get('zonggongyou'); ?> <b class="text_red_line"><?php echo $count; ?></b><?php echo \think\Lang::get('tiaojilu'); ?></p>
                                    </div>
                                </div>
                                <div class="box-body table-responsive">
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><?php echo \think\Lang::get('yonghuming'); ?></th>
                                                <th><?php echo \think\Lang::get('jine'); ?></th>
                                                <th><?php echo \think\Lang::get('leixing'); ?></th>
                                                <th><?php echo \think\Lang::get('duizhaoxinxi'); ?></th>
                                                <th><?php echo \think\Lang::get('dizhi'); ?></th>
                                                <th><?php echo \think\Lang::get('shijian'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php if($v['type'] == 1): ?>充值<?php endif; if($v['type'] == 2): ?>提现<?php endif; ?>
                                            </td>
                                            <td><?php echo $v['user_info']; ?></    >
                                            <td><?php echo $v['gathering_address']; ?></td>
