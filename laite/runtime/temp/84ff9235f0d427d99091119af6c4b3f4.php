<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\team\register.html";i:1512199956;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\footer.html";i:1512184643;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <ul class="sidebar-menu">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1><?php echo \think\Lang::get('zhuceliebiao'); ?></h1>
					<ol class="breadcrumb">
						<li>
							<a href="index.html"><i class="fa fa-dashboard"></i> <?php echo \think\Lang::get('shouye'); ?></a>
						</li>
						<li class="active"><?php echo \think\Lang::get('zhuceliebiao'); ?></li>
					</ol>
				</section>
						...
						<div class="col-xs-12">
							<div class="nav-tabs-custom">
								<div class="tab-content">
									...
									<div class="box-body">
										<div class="callout callout-info"><?php echo \think\Lang::get('zhucehuiyuan'); ?><?php echo \think\Lang::get('zonggongyou'); ?> <b class="text_red_line"><?php echo $count; ?></b> <?php echo \think\Lang::get('tiaojilu'); ?></div>
									</div>
									<div class="box-body table-responsive">
										<table class="table table-bordered table-hover">
											<thead>
												<tr>
													<th><?php echo \think\Lang::get('huiyuanzhanghao'); ?></th>
													<th><?php echo \think\Lang::get('huiyuanxingming'); ?></th>
													<th><?php echo \think\Lang::get('shoujihao'); ?></th>
													<th><?php echo \think\Lang::get('zhuceshijian'); ?></th>
											...
											<tbody>
												...
												<tr>
													<td class="cunzai"><?php echo $v['id']; ?></td>
													<td><?php echo $v['theme']; ?></td>
													<td><?php echo $v['phone']; ?></td>
													<td><?php echo date("Y-m-d H:i:s",$v['add_time']); ?></td>
													<td>
													<?php if($v['status'] == 0): ?><?php echo \think\Lang::get('weijihuo'); endif; if($v['status'] == 1): ?><?php echo \think\Lang::get('zhengchang'); endif; if($v['status'] == 2): ?><?php echo \think\Lang::get('fenghao'); endif; ?>
													</td>
												</tr>
									...
									<div class="no_info text-center tishi"><span class="glyphicon glyphicon-remove-circle"></span> <?php echo \think\Lang::get('zanwurenhejilu'); ?></div>
								</div>
