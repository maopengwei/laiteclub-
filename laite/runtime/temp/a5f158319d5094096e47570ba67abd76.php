<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\laite\public/../application/index\view\wealth\index.html";i:1512351589;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\footer.html";i:1512184643;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <section class="sidebar">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><?php echo \think\Lang::get('jihuomingxi'); ?></h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="index.html"><i class="fa fa-dashboard"></i> <?php echo \think\Lang::get('shouye'); ?></a>
                    </li>
                    <li class="active"><?php echo \think\Lang::get('jihuomingxi'); ?></li>
                </ol>
            </section>
            <!-- Main content -->
                            ...
                            <div class="tab-content">
                                <div class="box-body">
                                    <div class="callout callout-info">
                                        <p><?php echo \think\Lang::get('jihuomingxi'); ?>：<?php echo \think\Lang::get('zonggongyou'); ?> <b class="text_red_line"><?php echo $count; ?></b> 条记录</p>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo \think\Lang::get('jieshouyonghu'); ?></th>
                                                <th><?php echo \think\Lang::get('shumu'); ?></th>
