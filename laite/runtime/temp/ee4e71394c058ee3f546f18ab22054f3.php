<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpStudy\WWW\laite\public/../application/index\view\wealth\return_list.html";i:1512351608;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\footer.html";i:1512184643;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <section class="sidebar">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><?php echo \think\Lang::get('meirifenhong'); ?></h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="/index/index/index.html"><i class="fa fa-dashboard"></i><?php echo \think\Lang::get('shouye'); ?></a></li>
                    <li class="active"><?php echo \think\Lang::get('meirifenhong'); ?></li>
                </ol>
            </section>
            <!-- Main content -->
                            ...
                            <div class="tab-content">
                                <div class="box-body">
                                    <div class="callout callout-info">
                                        <p><?php echo \think\Lang::get('meirifenhong'); ?>：<?php echo \think\Lang::get('zonggongyou'); ?> <b class="text_red_line"><?php echo $count; ?></b><?php echo \think\Lang::get('tiaojilu'); ?></p>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo \think\Lang::get('laitebi'); ?></th>
                                                <th><?php echo \think\Lang::get('fuxiaobi'); ?></th>
                                                <th>ICO</th>
                                                <th><?php echo \think\Lang::get('gufen'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $v['litecoin']; ?></td>
                                            <td><?php echo $v['after']; ?></td>
