<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpStudy\WWW\laite\public/../application/index\view\wealth\leader.html";i:1512351909;s:77:"D:\phpStudy\WWW\laite\public/../application/index\view\layout\navigation.html";i:1512204930;}*/ ?>
<!DOCTYPE html>
<html>
...
<aside class="main-sidebar" style="margin-top: 14px">
    <section class="sidebar">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1><?php echo \think\Lang::get('jianglimingxi'); ?></h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="index.html"><i class="fa fa-dashboard"></i><?php echo \think\Lang::get('shouye'); ?></a>
                    </li>
                    <li class="active"><?php echo \think\Lang::get('jianglimingxi'); ?></li>
                </ol>
            </section>
            <!-- Main content -->
                            ...
                            <div class="tab-content">
                                <div class="box-body">
                                    <div class="callout callout-info">
                                        <p><?php echo \think\Lang::get('jianglimingxi'); ?>：<?php echo \think\Lang::get('zonggongyou'); ?> <b class="text_red_line"><?php echo $count; ?></b><?php echo \think\Lang::get('jianglimingxi'); ?></p>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo \think\Lang::get('laizifang'); ?></th>
                                                <th><?php echo \think\Lang::get('shuliang'); ?></th>
    ...
    <footer class="main-footer">
        ...
        <strong>版权 &copy; 2014-2017 <a href="#">莱特俱乐部</a>.</strong>LaiTe
    </footer>
    <!-- Control Sidebar -->
